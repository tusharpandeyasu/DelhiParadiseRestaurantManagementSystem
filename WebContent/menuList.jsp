...
<script type="text/javascript">
	...
	function addMember()
	{	
		var str0="<form name='addForm' action='MenuServlet?type=add&&which=food' method='post' enctype='multipart/form-data'>";
		...
		var str3="<li class='t2' style='width:120px;'><input type='text' style='border:none;text-align:left;' name='food_name' placeholder='Dish name'/></li>";
		
		var str4="<li class='t3' style='width:95px;'><input type='text' style='border:none;text-align:left;' name='cook' placeholder='Chef name'/></li>";
...
<%
	...
	List<Menu> list = MenuService.listAllFoods(); 
%>
...
<div class="body_bg">
	<div style="float:none;margin-left:105px;width:100px;height:40px;margin-top:30px;margin-bottom:5px;">
		<button style="width:100%;height:100%;" onclick="addMember();">+Add dishes</button>
	</div>
	<div id="contentArea">
		<ul class="table title" style="margin:auto; width:786px;">
			<li class="t1" style="width:75px;"><b>Recipe No.</b></li>
			<li class="t2" style="width:120px;"><b>Dish name</b></li>
			<li class="t3" style="width:95px;"><b>Chef</b></li>
			<li class="t4" style="width:75px;"><b>Price</b></li>
			<li class="t5" style="width:170px;"><b>View Details</b></li>
			<li class="t6" style="width:75px;"><b>Delete dishes</b></li>

		</ul>
		<%
		if(list!=null){
			for(int i=0;i<list.size();i++){
				Menu food= (Menu)list.get(i);
		%>
		<ul class="table interleaved_0" style="margin:auto; width:786px;">
				<li class="t1" style="width:75px;"><%=food.getFood_id()%></li>
				<li class="t2" style="width:120px;"><%=food.getFood_name()%></li>
				<li class="t3" style="width:95px;"><%=food.getCook() %></li>
				<li class="t4" style="width:75px;"><%=food.getFood_price() %></li>
				<li class="t5" style="width:170px;"><a href="#">View</a></li>
				<li class="t6" style="width:75px;"><a href="MenuServlet?type=delete&&food_id=<%=food.getFood_id()%>&&which=food">delete</a></li>
		</ul>
		...
		<div style="margin:auto; width:786px;border:1px solid #3388FF;height:180px;display:none;">
			<div style="width:180px;float:left;height:180px;">
				<img style="width:180px;height:180px;" src="MenuImages/<%=food.getFood_image_path() %>" />
			</div>
